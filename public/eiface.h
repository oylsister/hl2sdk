...
{
  public:
    CPlayerUserId(int index) { _index = index; }
...
abstract_class ISource2Server : public IAppSystem
{
  public:
    ...
    virtual void GetEconItemNamesForModel(const char* pModelName, bool bExcludeItemSets, bool bExcludeIndividualItems,
                                          CUtlVector<CUtlString>& econItemNames) = 0;
    virtual void GetEconItemNamesForCharacter(const char* pCharacterName, bool bExcludeItemSets, bool bExcludeIndividualItems,
                                              CUtlVector<CUtlString>& econItemNames) = 0;
    virtual void GetEconItemsInfoForModel(const char* pModelName, const char* pEconItemName, bool bExcludeItemSets,
                                          bool bExcludeIndividualItems, bool bExcludeStockItemSet,
                                          CUtlVector<EconItemInfo_t>& econInfo) = 0;
    virtual void GetEconItemsInfoForCharacter(const char* pCharacterName, const char* pEconItemName, bool bExcludeItemSets,
                                              bool bExcludeIndividualItems, bool bExcludeStockItemSet,
                                              CUtlVector<EconItemInfo_t>& econInfo) = 0;
...
abstract_class ISource2GameEntities : public IAppSystem
{
  public:
    ...
    virtual bool ShouldClientReceiveStringTableUserData(const INetworkStringTable* pTable, int stringNumber,
                                                        const CCheckTransmitInfo* pInfo) = 0;
...
{
  public:
    virtual void OnClientConnected(CPlayerSlot slot, const char* pszName, uint64 xuid, const char* pszNetworkID, const char* pszAddress,
                                   bool bFakePlayer) = 0;
    ...
    virtual bool ClientConnect(CPlayerSlot slot, const char* pszName, uint64 xuid, const char* pszNetworkID, bool unk1,
    ...
    virtual void ClientDisconnect(CPlayerSlot slot, ENetworkDisconnectionReason reason, const char* pszName, uint64 xuid,
